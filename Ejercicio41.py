...
class Alumno:
    ...
    def __init__(self, nombre: str, numero_control: str, carrera=None):
        ...
        self.numero_control = numero_control # Número de control (ID único)
        self.carrera = carrera # Carrera asignada (objeto Carrera)               
        self.calificaciones = {} # Diccionario de calificaciones por materia
...
class Universidad:
    def __init__(self, nombre: str):
        self.nombre = nombre
        self.carreras = [] # Lista de carreras disponibles      
        self.alumnos = [] # Lista de alumnos registrados      
        self.profesores = [] # Lista de profesores registrados   
